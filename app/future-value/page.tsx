    ...
    <CalculatorShell
      ...
      belowFold={
        <Zone
          ...
          aside={
            <button
              className="focusable -m-1 inline-flex min-h-[36px] items-center p-1 font-mono text-xs text-accent underline decoration-dotted underline-offset-4 hover:decoration-solid"
