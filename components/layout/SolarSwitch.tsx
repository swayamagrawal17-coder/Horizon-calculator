...
/** The animated sun/moon icon — split into its own chunk (see ThemeToggle.tsx)
 * so framer-motion isn't part of every page's initial script parse. */
export function SolarSwitch({ isDark }: { isDark: boolean }) {
